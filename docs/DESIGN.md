...
> Design notes for **fieldservice-photo-handoff** — a runnable typescript example that Typed Node service for presigned work-order photo uploads and dispatch follow-up decisions.
...
- **Feature code** — the actual task: work-order-photo-upload.
